...
function App() {
  ...
  // rule flags this). Instead, a ticking effect recalculates "seconds ago"
  // every second — this also means the label updates live instead of only
  // refreshing when some unrelated re-render happens to occur.
