...
const chartConfig = {
  eco2: { label: "eCO2 (ppm)", color: "var(--chart-1)" },
  tvoc: { label: "TVOC (ppb)", color: "var(--chart-2)" },
    ...
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>eCO2 and TVOC over the selected period</CardDescription>
        </div>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        {isLoading ? (
          ...
          <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
            <AreaChart data={data}>
              <defs>
                <linearGradient id="fillEco2" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-eco2)" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="var(--color-eco2)" stopOpacity={0.1} />
                </linearGradient>
                <linearGradient id="fillTvoc" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-tvoc)" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="var(--color-tvoc)" stopOpacity={0.1} />
                </linearGradient>
              </defs>
              ...
              />
              <Area dataKey="eco2" type="natural" fill="url(#fillEco2)" stroke="var(--color-eco2)" />
              <Area dataKey="tvoc" type="natural" fill="url(#fillTvoc)" stroke="var(--color-tvoc)" />
